  ...
  return (
    <div className="max-w-4xl mx-auto py-20 px-8">
      <div className="glass-panel p-12 text-center">
        ...
        <div className="mt-12 p-8 border border-white/5 bg-white/5 rounded-2xl flex flex-col md:flex-row items-center justify-between gap-6 text-left max-w-2xl mx-auto relative z-50">
          ...
          <div className="flex gap-4 w-full md:w-auto flex-shrink-0 relative z-50">
            <a
              href="https://wa.me/919181042005"
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 md:flex-initial flex items-center justify-center gap-3 bg-[#25D366]/10 hover:bg-[#25D366] hover:text-white border border-[#25D366]/20 px-8 py-4 rounded-xl transition-all text-xs font-bold text-[#25D366] active:scale-95 shadow-lg relative z-50"
            >
            ...
            <a
              href="tel:7002475079"
              className="flex-1 md:flex-initial flex items-center justify-center gap-3 bg-[var(--accent-primary)]/10 hover:bg-[var(--accent-primary)] hover:text-white border border-[var(--accent-primary)]/20 px-8 py-4 rounded-xl transition-all text-xs font-bold text-[var(--accent-primary)] active:scale-95 shadow-lg relative z-50"
            >
              <Phone size={20} />
              Call Now
            </a>
