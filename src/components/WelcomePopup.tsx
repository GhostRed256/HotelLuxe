       ...
       {isOpen && (
         ...
         >
           <motion.div
             ...
             className="relative glass-panel p-10 max-w-lg w-full text-center ornate-border cursor-default palace-bg overflow-hidden"
           ...
           >
             ...
             <button 
               onClick={() => { setIsOpen(false); sessionStorage.setItem("welcome_seen", "1") }}
             ...
             <h2 className="text-4xl md:text-6xl font-heading font-black mb-6 tracking-tight leading-none">
               <span className="gold-shimmer block mb-2">Luxury Awaits</span>
               <span className="text-[var(--accent-primary)]">You</span>
             </h2>
